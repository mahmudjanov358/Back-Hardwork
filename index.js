...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    tags: [
      { name: "Role-1", description: "Role bo‘limi bilan ishlash" },
      { name: "Stuff-2", description: "Stuff bo‘limi bilan ishlash" },
      {
        name: "Stuff_Role-3",
        description: "Stuff_Role bo‘limi bilan ishlash",
      },
      { name: "Stage-4", description: "Stage bo‘limi bilan ishlash" },
      { name: "Branch-5", description: "Branch bo‘limi bilan ishlash" },
      { name: "Group-6", description: "Group bo‘limi bilan ishlash" },
      {
        name: "Group_Stuff-7",
        description: "Group_Stuff bo‘limi bilan ishlash",
      },
      { name: "Lesson-8", description: "Lesson bo‘limi bilan ishlash" },
      { name: "Lid_Status-9", description: "Lid_Status bo‘limi bilan ishlash" },
      {
        name: "Reason_Lid-10",
        description: "Reason_Lid bo‘limi bilan ishlash",
      },
      { name: "Lid-11", description: "Lid bo‘limi bilan ishlash" },
      { name: "Students-12", description: "Students bo‘limi bilan ishlash" },
      {
        name: "Student_Group-13",
        description: "Student_Group bo‘limi bilan ishlash",
      },
      {
        name: "Student_Lesson-14",
        description: "Student_Lesson bo‘limi bilan ishlash",
      },
      { name: "Payment-15", description: "Payment bo‘limi bilan ishlash" },
    ],
  },
  apis: ["./routers/*.js"],
};
