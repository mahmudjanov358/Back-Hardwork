...
const swaggerOptions = {
  swaggerDefinition: {
    ...
    tags: [
      { name: "Role", description: "Role bo‘limi bilan ishlash" },
      { name: "Stuff", description: "Stuff bo‘limi bilan ishlash" },
      {
        name: "Stuff_Role",
        description: "Stuff_Role bo‘limi bilan ishlash",
      },
      { name: "Stage", description: "Stage bo‘limi bilan ishlash" },
      { name: "Branch", description: "Branch bo‘limi bilan ishlash" },
      { name: "Group", description: "Group bo‘limi bilan ishlash" },
      {
        name: "Group_Stuff",
        description: "Group_Stuff bo‘limi bilan ishlash",
      },
      { name: "Lesson", description: "Lesson bo‘limi bilan ishlash" },
      { name: "Lid_Status", description: "Lid_Status bo‘limi bilan ishlash" },
      { name: "Reason_Lid", description: "Reason_Lid bo‘limi bilan ishlash" },
      { name: "Lid", description: "Lid bo‘limi bilan ishlash" },
      { name: "Students", description: "Students bo‘limi bilan ishlash" },
      {
        name: "Student_Group",
